...
namespace Pawotter.Core.Entities
{
    ...
    public class Account
    {
        ...
        public override string ToString() => string.Format("[Account: Id={0}, Username={1}, Acct={2}, DisplayName={3}, isLocked={4}, CreatedAt={5}, FollowersCount={6}, FollowingCount={7}, StatusesCount={8}, Note={9}, Url={10}, Avatar={11}, AvatarStatic={12}, Header={13}, HeaderStatic={14}]", Id, Username, Acct, DisplayName, IsLocked, CreatedAt, FollowersCount, FollowingCount, StatusesCount, Note, Url, Avatar, AvatarStatic, Header, HeaderStatic);
        ...
        public override int GetHashCode() => Object.GetHashCode(Id, Username, Acct, DisplayName, IsLocked, CreatedAt, FollowingCount, FollowersCount, StatusesCount, Note, Url, Avatar, AvatarStatic, Header, HeaderStatic);
    }
}
