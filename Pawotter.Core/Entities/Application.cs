...
namespace Pawotter.Core.Entities
{
    ...
    public class Application
    {
        ...
        public override string ToString() => string.Format("[Application: Name={0}, Website={1}]", Name, Website);
        ...
        public override int GetHashCode() => Object.GetHashCode(Name, Website);
    }
}
