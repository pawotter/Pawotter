...
namespace Pawotter.Core.Entities
{
    ...
    public class Results
    {
        ...
        public override string ToString() => string.Format("[Results: Accounts={0}, Statuses={1}, Hashtags={2}]", Accounts, Statuses, Hashtags);
        ...
        public override int GetHashCode() => Object.GetHashCode(Accounts, Statuses, Hashtags);
    }
}
