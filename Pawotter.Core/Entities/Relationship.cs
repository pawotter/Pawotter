...
namespace Pawotter.Core.Entities
{
    ...
    public class Relationship
    {
        ...
        public override string ToString() => string.Format("[Relationship: Id={0}, IsFollowing={1}, IsFollowedBy={2}, IsBlocking={3}, IsMuting={4}, IsRequested={5}]", Id, IsFollowing, IsFollowedBy, IsBlocking, IsMuting, IsRequested);
        ...
        public override int GetHashCode() => Object.GetHashCode(Id, IsFollowing, IsFollowedBy, IsBlocking, IsMuting, IsRequested);
    }
}
