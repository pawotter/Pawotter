...
namespace Pawotter.Core.Entities
{
    ...
    public class Attachment
    {
        ...
        public override string ToString() => string.Format("[Attachment: Id={0}, Type={1}, Url={2}, RemoteUrl={3}, PreviewUrl={4}, TextUrl={5}]", Id, Type, Url, RemoteUrl, PreviewUrl, TextUrl);
        ...
        public override int GetHashCode() => Object.GetHashCode(Id, Type, Url, RemoteUrl, PreviewUrl, TextUrl);
    }
}
