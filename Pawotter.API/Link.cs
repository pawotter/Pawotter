...
namespace Pawotter.API
{
    public struct Link
    {
        ...
        public override string ToString() => string.Format("[Link: MaxId={0}, SinceId={1}]", MaxId, SinceId);
        ...
        public override int GetHashCode() => Core.Object.GetHashCode(MaxId, SinceId);
