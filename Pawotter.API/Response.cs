...
namespace Pawotter.API
{
    public class Response<T>
    {
        ...
        public override string ToString() => string.Format("[Response: Resource={0}, Message={1}]", Resource, Message);
        ...
        public override int GetHashCode() => Core.Object.GetHashCode(Resource, Message);
    }
}
